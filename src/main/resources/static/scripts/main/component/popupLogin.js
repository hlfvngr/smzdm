(function (window) {
    ...
    Base.mix(PopupLogin, Component, {
            ...
            '<div class="wrapper-content clearfix">',
                '<div class="input-section">',
                    '<div class="form-group">',
                        ...
                        '<div class="control-group js-name"><input type="email" placeholder="请输入用户名"></div>',
                    '</div>',
                    '<div class="form-group">',
        ...
        listeners: [{
            ...
            handler: function () {
                var that = this;
                var oEl = that.getEl();
                that.nameIpt = oEl.find('div.js-name');
                ...
                $.ajax({
                    ...
                    if (oResult.code === 0) {
                       window.location.reload();
                        ...
                        oResult.msgname && that.iptError(that.nameIpt, oResult.msgname);
    ...
    function fInitCpn() {
        var that = this;
        that.nameIpt.find('input').on('focus', Base.bind(that.iptNone, that, that.nameIpt));
